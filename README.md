...
This NIC is part of the bridge vmbr1. Any Proxmox VM bridged to vmbr1 will be visible from the Windows 10 Host.
The internal bridge vmbr0, is collecting the internal traffic and forward it to the first NIC OUTBOUND interface.

Using this network configuration, the proxmeox server in VirtualBox, and all VM in proxmox are visible from the Microsoft Windows 10 
